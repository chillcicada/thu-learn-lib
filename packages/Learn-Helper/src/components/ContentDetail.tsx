...
function Line({ title, children }: LineProps) {
  const { _ } = useLingui()
...
function Link({ url, inApp, children }: LinkProps) {
...
function canFilePreview(file: RemoteFile): boolean {
...
function FileLinks({ downloadTitle, previewTitle, file }: FileLinkProps) {
  return (
    <>
...
function translateFileType(type: string): string {
  return type
}
...
function FileDetails({ content: file }: ContentDetailProps<FileInfo>) {
  return (
    <>
...
function HomeworkDetails({ content: homework }: ContentDetailProps<HomeworkInfo>) {
  const { _ } = useLingui()
...
function NotificationDetails({ content: notification }: ContentDetailProps<NotificationInfo>) {
  return (
    <>
...
function ContentDetail({ content }: ContentDetailProps) {
  const { _ } = useLingui()
